...
STATUTES = [
    ...
    {
        # 시행령 별칭은 법률 별칭보다 길어야 최장 일치에서 이긴다("학교폭력예방법 시행령 제17조")
        'name': '학교폭력예방 및 대책에 관한 법률 시행령',
        'aliases': ['학교폭력예방및대책에관한법률시행령', '학교폭력예방법시행령',
                    '학폭법시행령', '학교폭력법시행령', '학폭시행령'],
    },
]
...
TOPICS = [
    ...
    {'keywords': ['출장'],
     'refs': [('국가공무원 복무규정', '6')]},
    # 학교폭력 — 구체 주제를 먼저 두어야 포괄 주제('학교폭력')보다 먼저 걸린다
    {'keywords': ['심의위원회', '학폭위'],
     'refs': [('학교폭력예방 및 대책에 관한 법률 시행령', '13'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '14'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '14의2')]},
    {'keywords': ['자체해결', '학교장자체해결'],
     'refs': [('학교폭력예방 및 대책에 관한 법률', '13의2'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '14의3')]},
    {'keywords': ['분리조치', '즉시분리', '가해자와피해학생의분리'],
     'refs': [('학교폭력예방 및 대책에 관한 법률 시행령', '17의2')]},
    {'keywords': ['선도조치', '가해학생조치', '전학조치', '출석정지', '학급교체'],
     'refs': [('학교폭력예방 및 대책에 관한 법률', '17'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '19'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '20'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '21')]},
    {'keywords': ['피해학생보호', '피해학생지원', '보호조치'],
     'refs': [('학교폭력예방 및 대책에 관한 법률', '16'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '18'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '18의2')]},
    {'keywords': ['학교폭력예방교육', '학폭예방교육'],
     'refs': [('학교폭력예방 및 대책에 관한 법률 시행령', '17')]},
    {'keywords': ['전담기구'],
     'refs': [('학교폭력예방 및 대책에 관한 법률 시행령', '16')]},
    {'keywords': ['분쟁조정'],
     'refs': [('학교폭력예방 및 대책에 관한 법률 시행령', '25'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '27'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '28')]},
    {'keywords': ['학교폭력', '학폭'],
     'refs': [('학교폭력예방 및 대책에 관한 법률', '13의2'),
              ('학교폭력예방 및 대책에 관한 법률', '16'),
              ('학교폭력예방 및 대책에 관한 법률', '17'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '14'),
              ('학교폭력예방 및 대책에 관한 법률 시행령', '17의2')]},
    {'keywords': ['수업일수'],
     'refs': [('초ㆍ중등교육법 시행령', '45')]},
]
