...
exports.handler = async (event) => {
  ...
  const DATASET_RULES = {
    curr:
      ...
      'i) [근거] 중 문서명이 「든든첵 학교폭력 사안처리 Q&A(대구광역시교육청)」인 자료는 법령 원문이 아니라 대구광역시교육청이 만든 실무 안내(Q&A)입니다. 이 자료를 근거로 답할 때는 ① 대구광역시교육청의 실무 안내임을 밝히고, ② 법적 근거를 묻는 질문이면 「학교폭력예방 및 대책에 관한 법률」·같은 법 시행령의 조문을 함께 제시하며, ③ "시·도교육청마다 운영이 다를 수 있으니 소속 교육청의 최신 가이드북·공문을 확인하세요"를 덧붙입니다. 안내 내용을 법령 조문인 것처럼 단정해 서술하지 않습니다.\n\n',
  };
